...
type ClientInterface interface {
	...
	// CopyAssetWithBody request with any body
...
func (c *Client) GetUserSessionsAdmin(ctx context.Context, id openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetUserSessionsAdminRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CopyAssetWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCopyAssetRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CopyAsset(ctx context.Context, body CopyAssetJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCopyAssetRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetAssetOcr(ctx context.Context, id openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetAssetOcrRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetUserSessionsAdminRequest generates requests for GetUserSessionsAdmin
func NewGetUserSessionsAdminRequest(server string, id openapi_types.UUID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/admin/users/%s/sessions", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewCopyAssetRequest(server string, body CopyAssetJSONRequestBody) (*http.Request, error) {
	...
	bodyReader = bytes.NewReader(buf)
	return NewCopyAssetRequestWithBody(server, "application/json", bodyReader)
}

// NewCopyAssetRequestWithBody generates requests for CopyAsset with any type of body
func NewCopyAssetRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/assets/copy")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetAssetOcrRequest generates requests for GetAssetOcr
func NewGetAssetOcrRequest(server string, id openapi_types.UUID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/assets/%s/ocr", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewSearchLargeAssetsRequest(server string, params *SearchLargeAssetsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Ocr != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "ocr", runtime.ParamLocationQuery, *params.Ocr); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
type ClientWithResponsesInterface interface {
	...
	// GetUserSessionsAdminWithResponse request
	...
	// CopyAssetWithBodyWithResponse request with any body
	...
	// GetAssetOcrWithResponse request
...
// Status returns HTTPResponse.Status
func (r GetUserSessionsAdminResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// GetUserSessionsAdminWithResponse request returning *GetUserSessionsAdminResponse
func (c *ClientWithResponses) GetUserSessionsAdminWithResponse(ctx context.Context, id openapi_types.UUID, reqEditors ...RequestEditorFn) (*GetUserSessionsAdminResponse, error) {
	rsp, err := c.GetUserSessionsAdmin(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetUserSessionsAdminResponse(rsp)
}
...
// CopyAssetWithBodyWithResponse request with arbitrary body returning *CopyAssetResponse
func (c *ClientWithResponses) CopyAssetWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CopyAssetResponse, error) {
	rsp, err := c.CopyAssetWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CopyAssetWithResponse(ctx context.Context, body CopyAssetJSONRequestBody, reqEditors ...RequestEditorFn) (*CopyAssetResponse, error) {
	rsp, err := c.CopyAsset(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCopyAssetResponse(rsp)
...
// GetAssetOcrWithResponse request returning *GetAssetOcrResponse
func (c *ClientWithResponses) GetAssetOcrWithResponse(ctx context.Context, id openapi_types.UUID, reqEditors ...RequestEditorFn) (*GetAssetOcrResponse, error) {
	rsp, err := c.GetAssetOcr(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetAssetOcrResponse(rsp)
}
...
func ParseGetUserSessionsAdminResponse(rsp *http.Response) (*GetUserSessionsAdminResponse, error) {
	...
	response := &GetUserSessionsAdminResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
